...
**pcap2csv.sh** - Bulk converts PCAPs in a folder to CSVs. Data extracted from the PCAP is restricted to fields that are of use.<br/>
~~~
chmod a+x pcap2csv.sh <br/>
./pcap2csv.sh <br/>
~~~

**pcap2Ts.py** - Bulk processes CSVs generated from pcap2csv.sh and generates new CSVs that can be ingested directly into Timesketch.<br/>
~~~
